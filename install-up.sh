...
wget -q -O /usr/bin/menu-bot "https://raw.githubusercontent.com/Almonikacin/multi/main/update/menu-bot.sh" && chmod +x /usr/bin/menu-bot

sleep 2
echo -e "$COLOR1│${NC}  $COLOR1[INFO]${NC} Download Changelog File"
wget -q -O /root/changelog.txt "https://raw.githubusercontent.com/Almonikacin/permission/main/changelog.txt" && chmod +x /root/changelog.txt
